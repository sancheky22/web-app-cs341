...
var host = "34.82.19.81";    //from GCloud instance (change to match your db)
var database = "CHEESECAKE";  //database name
var user = "root";         //username (change to match your db)
var password = "broteinshakebro";  //password (change to match your db, yes this is very poor practice)
